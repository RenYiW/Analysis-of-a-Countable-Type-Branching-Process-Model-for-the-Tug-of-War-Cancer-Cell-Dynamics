---
title: "Embedded Process Simulation D1"
author: "Ren-Yi Wang"
date: "9/14/2022"
output: pdf_document
---
...
Drivers dominates passengers $(\mu L -\nu > 0)$ with $L = 2$.
...
$$
\text{Spec D1: } b_{0} = 1.1, \mu = 0.0251, \nu = 0.05, s_{p} = 0.002, L = 2.
$$
...
ext_prob = vector()
emp_dist = vector()
pop_size = matrix(rep(0,S*400),ncol = 400, nrow = S)
pop_size[,1] = 1
