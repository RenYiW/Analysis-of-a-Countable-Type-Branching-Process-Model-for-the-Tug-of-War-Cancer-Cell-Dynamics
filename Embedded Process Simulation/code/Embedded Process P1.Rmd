...
Passengers dominates drivers with $L = 2$.
...
ext_prob = vector()
emp_dist = vector()
pop_size = matrix(rep(0,S*300),ncol = 300, nrow = S)
pop_size[,1] = 1
