...
type_vs_ext_P3 <- as.data.frame(cbind(ini_types, ext_prob))

ggplot(type_vs_ext_P3, aes(x=ini_types, y=ext_prob)) + 
  geom_point() + xlab("Initial Types")+ylab("Extinction Probability")
ggsave("ext_prob_P3.png")

write.csv(type_vs_ext_P3,"type_vs_ext_P3.csv")
