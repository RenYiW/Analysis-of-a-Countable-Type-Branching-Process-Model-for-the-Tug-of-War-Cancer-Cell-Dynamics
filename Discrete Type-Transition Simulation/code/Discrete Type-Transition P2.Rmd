...
L <- 5
d <- 1 # Death rate
type_vs_ext = read.csv("C:/Users/ASUS/Desktop/Project/Extinction Probabilities/type_vs_ext_P2.csv")
...
plot(x = samp_type, y = type_freq[1,], 
     type = "h", col = cl[1], main = paste0("Discrete Type-Transition for Spec. P2, Trans=", Trans),
