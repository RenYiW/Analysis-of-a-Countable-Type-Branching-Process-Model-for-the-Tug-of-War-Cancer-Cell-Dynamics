---
title: "Discrete Type Transition D3"
author: "Ren-Yi Wang"
date: "9/14/2022"
...
L <- 10
d <- 1 # Death rate
type_vs_ext = read.csv("C:/Users/ASUS/Desktop/Project/Extinction Probabilities/type_vs_ext_D3.csv")
...
plot(x = samp_type, y = type_freq[1,], 
     type = "h", col = cl[1], main = paste0("Discrete Type-Transition for Spec. D3, Trans=", Trans),
