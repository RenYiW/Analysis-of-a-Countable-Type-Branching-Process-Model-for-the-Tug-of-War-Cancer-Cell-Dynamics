---
title: "Discrete Type Transition D2"
author: "Ren-Yi Wang"
date: "9/14/2022"
...
L <- 5
d <- 1 # Death rate
type_vs_ext = read.csv("C:/Users/ASUS/Desktop/Project/Extinction Probabilities/type_vs_ext_D2.csv")
...
Trans = 1000 # Number of Transitions in each simulation
type_trans = vector()
...
plot(x = samp_type, y = type_freq[1,], 
     type = "h", col = cl[1], main = paste0("Discrete Type-Transition for Spec. D2, Trans=", Trans),
     xlab = "Types", ylab = "Frequency")
